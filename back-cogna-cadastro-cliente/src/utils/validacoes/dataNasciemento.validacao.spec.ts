...
describe('Validação data de nascimento', () => {
  ...
  it('Data Inválida, exemplo amanhã, verifica se data de nascimento é no futuro.', () => {
    ...
    expect(validacaoDataNascimento(amanhaString)).toBeFalsy();
  });
});
